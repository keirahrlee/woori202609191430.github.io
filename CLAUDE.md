...
- **배포 URL**: `https://keirahrlee.github.io/woori202609191430.github.io/` (레포명이 계정명과 달라 프로젝트 사이트로 동작)
- **커스텀 도메인**: `*.github.io`는 GitHub 소유 도메인이라 설정 불가. 별도 도메인 구매 후 Pages 설정에서 등록 가능.
...
> **추가 필수**: 카카오 개발자 콘솔 → 제품 설정 → 카카오맵 → **사용 설정 ON** 해야 지도 작동.
...
```js
export const KAKAO_API_KEY = 'a...'; // [변경 필요] 내 카카오 API 키로 교체
